exports.translations = {
	commands: {
		...
		*/
		...
		suspect: {
			'suspect': 'Little Cup is currently suspecting Gothita and Diglett! Check it out here:'
		},
		viability: {
			'viability': 'Little Cup Viability Rankings:'
		},
		introductions: {
			'introductions': 'Little Cup Introductions Thread:'
		},
		resource: {
			'resource': 'Little Cup Resources Thread:'
		},
		
		timburr: {
			'timburr': 'A short guide on Timburr:'
		},
		time: {'time': 'Bot Time'},
		uptime: {
			'week': 'week',
